...
class GoodsIssued(models.Model):
    ...
    line_ids = fields.One2many('goods.issued.line', 'issued_id','Products to Issued',copy=True,track_visibility='onchange')
...
class GoodsIssuedLine(models.Model):
    ...
    issued_id = fields.Many2one('goods.issued','Goods Issued',ondelete='cascade', readonly=True)
